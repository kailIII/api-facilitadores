...
class Blade {
	...
	/**
	 * Rewrites Blade @yieldLaravel statements into Section statements.
	 *
	 * The Blade @yieldLaravel statement is a shortcut to the Section::yieldLaravel method.
	 *
	 * @param  string  $value
	 * @return string
	 */
	protected static function compile_yieldLaravels($value)
	{
		$pattern = static::matcher('yieldLaravel');

		return preg_replace($pattern, '$1<?php echo \\Laravel\\Section::yieldLaravel$2; ?>', $value);
	}

	/**
	 * Rewrites Blade yieldLaravel section statements into valid PHP.
	 *
	 * @return string
	 */
	protected static function compile_yieldLaravel_sections($value)
	{
		$replace = '<?php echo \\Laravel\\Section::yieldLaravel_section(); ?>';

		return str_replace('@yieldLaravel_section', $replace, $value);
	}
