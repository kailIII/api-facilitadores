...
class BladeTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * Test the compilation of yieldLaravel statements.
	 *
	 * @group laravel
	 */
	public function testYieldsAreCompiledCorrectly()
	{
		$blade = "@yieldLaravel('something')";

		$this->assertEquals("<?php echo \\Laravel\\Section::yieldLaravel('something'); ?>", Blade::compile_string($blade));
	}
